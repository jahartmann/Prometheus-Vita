...
export function MetricsSummaryCards({ summary }: MetricsSummaryCardsProps) {
  const cards = [
    ...
    },
    {
      label: "RAM",
      icon: MemoryStick,
      current: summary.memory_current_percent ?? summary.memory_avg_percent,
    ...
    },
    {
      label: "Disk",
      icon: HardDrive,
      current: summary.disk_current_percent ?? summary.disk_avg_percent,
