...
export function SearchCommand() {
  ...
  const navigationItems: SearchResult[] = useMemo(
    () => [
      ...
      { id: "nav-alerts", category: "navigation" as SearchCategory, icon: AlertTriangle, label: "Alerts", description: "Warnungen und Bestätigungen", href: "/alerts", tags: ["alarm", "warnung"] },
      { id: "nav-tasks", category: "navigation" as SearchCategory, icon: Clock, label: "Tasks", description: "Aufgaben und laufende Operationen", href: "/task-center", tags: ["task", "jobs", "aufgaben"] },
      ...
      { id: "nav-storage", category: "navigation" as SearchCategory, icon: HardDrive, label: "Storage", description: "Speicher und Kapazität", href: "/storage", tags: ["speicher", "disk"] },
      ...
      { id: "nav-reports", category: "navigation" as SearchCategory, icon: BarChart3, label: "Reports", description: "Berichte und Nachweise", href: "/reports", tags: ["bericht", "report"] },
      ...
      { id: "nav-root-cause", category: "navigation" as SearchCategory, icon: Sparkles, label: "Root Cause", description: "Ursachenanalyse", href: "/root-cause", tags: ["analyse", "incident"] },
      { id: "nav-reflex", category: "navigation" as SearchCategory, icon: Zap, label: "Reflex", description: "Automatische Regeln", href: "/reflex", tags: ["automation", "regel"] },
      { id: "nav-knowledge", category: "navigation" as SearchCategory, icon: Hash, label: "Knowledge Graph", description: "Wissensbasis und Beziehungen", href: "/knowledge-graph", tags: ["wissen", "brain", "graph"] },
