...
export default function SearchPage() {
  ...
  const allItems = useMemo(() => {
    ...
    const pages: Omit<SearchResult, "id" | "category">[] = [
      {
        title: "Dashboard",
        subtitle: "Überblick über Nodes, Aufgaben und KPIs",
        href: "/",
        icon: LayoutGrid,
      ...
      {
        title: "Lagebrief",
        subtitle: "KI-gestützte Infrastruktur-Zusammenfassung",
        href: "/briefing",
        icon: TrendingUp,
      ...
      },
      {
        ...
        subtitle: "Recovery-Pläne, Runbooks und Readiness",
      ...
      {
        title: "KI-Chat",
        subtitle: "Assistent für Infrastrukturfragen",
        href: "/chat",
        icon: Sparkles,
      ...
      {
        title: "Sicherheit",
        subtitle: "Sicherheitsübersicht und Events",
        href: "/security",
        icon: ShieldCheck,
