...
const settingsGroups = [
  {
    ...
    items: [
      ...
      { label: "VM-Berechtigungen", href: "/settings/vm-permissions", icon: FolderLock, badge: "Bereiche" },
      { label: "VM-Gruppen", href: "/settings/vm-groups", icon: Monitor, badge: "Bereiche" },
      { label: "API-Tokens", href: "/settings/api-tokens", icon: Shield, badge: "Bereiche" },
  ...
  {
    title: "KI, Wissen & Benachrichtigungen",
    description: "Agent, lokale KI, Wissensbasis und Benachrichtigungen steuern.",
    items: [
      { label: "KI-Assistent", href: "/settings/agent", icon: Bot, badge: "LLM" },
      { label: "Wissensbasis", href: "/settings/brain", icon: Brain, badge: "Wissen" },
      { label: "Benachrichtigungen", href: "/settings/notifications", icon: Bell, badge: "Alarme" },
    ],
  },
];
